...
import com.notificationhubs.implementation.NotificationsImpl;
import reactor.core.publisher.Mono;

/** Initializes a new instance of the asynchronous AzureNotificationHubsServiceClient type. */
@ServiceClient(builder = NotificationsClientBuilder.class, isAsync = true)
public final class NotificationsAsyncClient {
    @Generated private final NotificationsImpl serviceClient;

    /**
     * Initializes an instance of NotificationsAsyncClient class.
     *
     * @param serviceClient the service client implementation.
     */
    @Generated
    NotificationsAsyncClient(NotificationsImpl serviceClient) {
    ...
    public Mono<Response<BinaryData>> sendNotificationWithResponse(
        ...
        return this.serviceClient.sendNotificationWithResponseAsync(
                test, serviceBusNotificationFormat, notification, requestOptions);
    }
}
