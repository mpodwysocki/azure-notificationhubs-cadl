...
@ServiceClient(builder = ListRegistrationsByTagClientBuilder.class)
public final class ListRegistrationsByTagClient {
    @Generated private final ListRegistrationsByTagAsyncClient client;

    /**
     * Initializes an instance of ListRegistrationsByTagClient class.
     *
     * @param client the async client.
     */
    @Generated
    ListRegistrationsByTagClient(ListRegistrationsByTagAsyncClient client) {
        this.client = client;
    }
    ...
    public Response<BinaryData> listWithResponse(String tag, RequestOptions requestOptions) {
        return this.client.listWithResponse(tag, requestOptions).block();
    }
}
