...
@ServiceClient(builder = InstallationsClientBuilder.class)
public final class InstallationsClient {
    @Generated private final InstallationsAsyncClient client;

    /**
     * Initializes an instance of InstallationsClient class.
     *
     * @param client the async client.
     */
    @Generated
    InstallationsClient(InstallationsAsyncClient client) {
        this.client = client;
    }
    ...
    public Response<BinaryData> getWithResponse(String installationId, RequestOptions requestOptions) {
        return this.client.getWithResponse(installationId, requestOptions).block();
    }
    ...
    public Response<Void> deleteWithResponse(String installationId, RequestOptions requestOptions) {
        return this.client.deleteWithResponse(installationId, requestOptions).block();
    }
    ...
    public Response<Void> createOrUpdateWithResponse(
        ...
        return this.client.createOrUpdateWithResponse(installationId, installation, requestOptions).block();
    }
    ...
    public Response<Void> updateWithResponse(String installationId, BinaryData updates, RequestOptions requestOptions) {
        return this.client.updateWithResponse(installationId, updates, requestOptions).block();
    }
}
